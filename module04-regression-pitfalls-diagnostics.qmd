...
format:
  live-html:
    toc: true
---
# Regression Pitfalls and Diagnostics {#sec-regression-pitfalls-and-diagnostics}
...
::: Example
### The importance of checking residuals: Anscombe's quartet {#sec-the-importance-of-checking-residuals-anscombe-s-quartet}
...
### Extracting residuals and `broom::augment()` {#sec-extracting-residuals-and-broom-augment}
...
### Common diagnostic plots {#sec-common-diagnostic-plots}
...
## Residual plots vs predictors and fitted values {#sec-residual-plots-vs-predictors-and-fitted-values}
...
## Diagnosing nonconstant variance and nonlinearity {#sec-diagnosing-nonconstant-variance-and-nonlinearity}
...
## Assessing normality of residuals {#sec-assessing-normality-of-residuals}
...
## Standardised residuals, leverage, Cook's distance {#sec-standardised-residuals-leverage-cook-s-distance}
