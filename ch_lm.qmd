...
```{ojs ch-lm-linear-prediction-view}
//| panel: sidebar
//| echo: false
...
```{ojs ch-lm-linear-prediction-ojs}
//| panel: fill
//| echo: false
xRange = [-10,10]
...
```{r ch-lm-salary-growth-over-time-plot}
#| echo: false
...
```{r ch-lm-salary-growth-over-time-code}
#| eval: false
ggplot() +
  geom_abline(intercept = 5e4, slope = 5e3, colour = '#2196F3') +
  lims(x = c(0, 15), y = c(4e4, 13e4)) +
...
```{webr ch-lm-choosing-parameters}
#| exercise: ex_1.1.1
#| envir: Ex1
alpha <- _______
beta <- _______
...
```{webr ch-lm-choosing-parameters-solution}
#| exercise: ex_1.1.1
#| solution: true
#| envir: Ex1
alpha <- 70000
...
```{webr ch-lm-choosing-parameters-solution-2}
#| exercise: ex_1.1.1
#| check: true
#| class: wait
#| envir: Ex1
...
```{r ch-lm-linear-prediction-plot}
#| echo: false
...
```{r ch-lm-linear-prediction-code}
#| eval: false
ggplot() +
  geom_abline(aes(intercept = 7e4, slope = 3e3, colour = "Company B")) +
  geom_abline(aes(intercept = 5e4, slope = 5e3, colour = "Company A")) +
...
```{webr ch-lm-linear-prediction-code-2}
#| exercise: ex_1.1.2
#| envir: Ex1
...
```{webr ch-lm-linear-prediction-code-3}
#| exercise: ex_1.1.2
#| solution: true
#| envir: Ex1
E_Y <- alpha + (beta * 15)
...
```{webr ch-lm-linear-prediction-code-4}
#| exercise: ex_1.1.2
#| check: true
#| class: wait
#| envir: Ex1
...
```{webr ch-lm-using-r-functions-2}
#| edit: false
...
```{webr ch-lm-using-r-functions-3}
#| edit: false
x <- c(9, 4, 5, 2, 6)
```

```{webr ch-lm-using-r-functions-4}
#| exercise: ex_1.1.3
#| envir: Ex1
...
```{webr ch-lm-using-r-functions-5}
#| exercise: ex_1.1.3
#| solution: true
...
```{webr ch-lm-using-r-functions-6}
#| exercise: ex_1.1.3
#| check: true
#| class: wait
gradethis::grade_this_code()
...
```{ojs ch-lm-normal-distribution-view}
//| echo: false
//| panel: sidebar
...
```{ojs ch-lm-normal-distribution-ojs}
//| echo: false
//| panel: fill
...
```{ojs ch-lm-variation-in-salary-view}
//| echo: false
//| panel: sidebar
...
```{ojs ch-lm-variation-in-salary-ojs}
//| echo: false
//| panel: fill
...
:::: {}
```{webr ch-lm-normally-distributed-errors}
#| exercise: ex_1.2.1
#| envir: Ex2
...
```{webr ch-lm-normally-distributed-errors-solution}
#| exercise: ex_1.2.1
#| solution: true
#| envir: Ex2
...
```{webr ch-lm-normally-distributed-errors-solution-2}
#| exercise: ex_1.2.1
#| check: true
#| class: wait
#| envir: Ex2
...
```{ojs ch-lm-the-simple-linear-model-view}
//| panel: sidebar
//| echo: false
...
```{ojs ch-lm-the-simple-linear-model-ojs}
//| panel: fill
//| echo: false
//| width: 700
...
```{r ch-lm-a-simple-linear-model-in-r-simulate}
n <- 100
...
```{r ch-lm-a-simple-linear-model-in-r-simulate-2}
...
```{r ch-lm-a-simple-linear-model-in-r}
...
```{r ch-lm-a-simple-linear-model-in-r-setup}
#| echo: false
...
```{r ch-lm-a-simple-linear-model-in-r-code}
#| eval: false
library(ggplot2)
...
```{webr ch-lm-a-simple-linear-model-in-r-code-2}
#| code-fold: true
