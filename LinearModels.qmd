...
//| panel: fill
//| echo: false
//| fig-cap: "Plot of the linear function E[Y] = α + βX"
xRange = [-10,10]
...
-   Here, $\alpha$ represents the expected value of $Y$ ($E[Y]$) when $X=0$, and $\beta$ represents the change in $E[Y]$ for a one-unit increase in $X$.

::: Assumption {#assumption-linearity}
