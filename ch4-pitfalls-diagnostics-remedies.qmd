...
These data are clearly very different, howerver each has the same summary statistics: 
...
The key lesson from Anscombe's quartet is that regression summaries can hide important aspects of the data. Therefore, a necessary step in **any** regression analysis is to check whether the assumptions of the linear model are reasonably satisfied by the data at hand.
:::
...
#| edit: false
ggplot(olympic, aes(x = fitted, y = residuals)) +
...
```{webr chapter04-regression-pitfalls-diagnostics-diagnostic-model-setup}
#| edit: false
...
:::: {.panel-tabset}
### Residuals vs fitted
```{webr chapter04-regression-pitfalls-diagnostics-residuals-vs-fitted}
#| edit: false
...
### Normal Q–Q
```{webr chapter04-regression-pitfalls-diagnostics-normal-qq}
#| edit: false
...
### Scale–location
```{webr chapter04-regression-pitfalls-diagnostics-scale-location}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-residuals-vs-leverage}
#| edit: false
