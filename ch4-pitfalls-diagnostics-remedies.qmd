...
```{webr chapter04-regression-pitfalls-diagnostics-setup}
theme_set(theme_bw())
```

```{r chapter04-regression-pitfalls-diagnostics-setup-r}
library(tidyverse)
library(broom)
library(MASS)
theme_set(theme_bw())
...
:::: {.panel-tabset}
### Scatter plots
```{webr chapter04-regression-pitfalls-diagnostics-anscombe-setup}
...
### dataset
```{webr chapter04-regression-pitfalls-diagnostics-anscombe-scatter}

anscombe
```
::::

These data are clearly very different; however, each dataset has the same summary statistics:
```{webr chapter04-regression-pitfalls-diagnostics-anscombe-summary}
...
:::: {.panel-tabset}
### fitted lines
```{webr chapter04-regression-pitfalls-diagnostics-anscombe-fitted-lines}
...
### Regression summary
```{webr chapter04-regression-pitfalls-diagnostics-anscombe-regression}
...
```{webr chapter04-regression-pitfalls-diagnostics-olympic-data}
#| edit: false
...
::: {.panel-tabset}
## Scatter plot 
```{webr chapter04-regression-pitfalls-diagnostics-olympic-data-scatter}
#| edit: false
...
## Data table
```{webr chapter04-regression-pitfalls-diagnostics-olympic-data-table}
#| edit: false
olympic
```
:::
...
```{webr chapter04-regression-pitfalls-diagnostics-olympic-setup}
#| edit: false
...
:::: {.panel-tabset}
### Residuals vs fitted
```{webr chapter04-regression-pitfalls-diagnostics-olympic-residuals-vs-fitted}
#| edit: false
...
### Residuals vs FAT
```{webr chapter04-regression-pitfalls-diagnostics-olympic-residuals-vs-fat}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-olympic-augment-preview}
#| edit: false
olympic_mod |>
  augment() |> 
...
```{webr chapter04-regression-pitfalls-diagnostics-olympic-influence-table}
#| edit: false
olympic_mod |>
  augment() |>
...
```{r chapter04-regression-pitfalls-diagnostics-diagnostic-model-setup}
#| edit: false
diag_mod <- lm(mpg ~ wt + hp + am, data = mtcars)
```
We will use `broom::augment()` to extract the residuals and other diagnostics.
```{r chapter04-regression-pitfalls-diagnostics-diagnostic-model-augment}
#| edit: false
...
```{r chapter04-regression-pitfalls-diagnostics-residuals-vs-fitted-ggplot}
#| edit: false
...
```{r chapter04-regression-pitfalls-diagnostics-scale-location-ggplot}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-normal-qq-ggplot}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-residuals-vs-leverage-ggplot}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-plot-lm}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-nonlinearity-sim}
#| edit: false
set.seed(42)
n <- 80
x <- runif(n, -3, 3)
...
```{webr chapter04-regression-pitfalls-diagnostics-nonlinearity-lin-resid}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-nonlinearity-quad-resid}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-hetero-sim}
#| edit: false
set.seed(7)
n <- 120
x <- runif(n, 0, 10)
...
:::: {.panel-tabset}
### Residuals (raw scale)
```{webr chapter04-regression-pitfalls-diagnostics-hetero-raw}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-hetero-log}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-independence-sim}
#| edit: false
set.seed(99)
n <- 90
time <- seq_len(n)
...
:::: {.panel-tabset}
### Residuals vs time
```{webr chapter04-regression-pitfalls-diagnostics-independence-resid-time}
#| edit: false
...
### ACF of residuals
```{webr chapter04-regression-pitfalls-diagnostics-independence-acf}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-extrapolation-range}
#| edit: false
tibble(
  predictor = c("wt", "hp"),
...
```{webr chapter04-regression-pitfalls-diagnostics-boxcox}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-vif-helper}
#| edit: false
...
```{webr chapter04-regression-pitfalls-diagnostics-vif-example}
#| edit: false
...
### Exercise 2: Use VIF to spot multicollinearity {#sec-chapter04-exercise-2}

Fit the model and compute VIFs. Which term has the largest VIF?

```{webr chapter04-regression-pitfalls-diagnostics-ex2-setup}
#| echo: false
#| edit: false
...
### Exercise 3: Interpret a Box–Cox suggestion {#sec-chapter04-exercise-3}
