...
```{webr chapter02-mlr-advertising-sales-load-data}
#| edit: false
...
```{webr chapter02-mlr-advertising-sales}
#| edit: false
ads
```
...
```{webr chapter02-mlr-sales-tv-plot}
#| edit: false
#| echo: false
...
```{webr chapter02-mlr-sales-radio-plot}
#| edit: false
#| echo: false
...
```{webr chapter02-mlr-coloured-scatter-plot}
#| edit: false
#| echo: false
...
```{webr chapter02-mlr-3-d-scatter}
#| edit: false
#| echo: false
...
```{webr chapter02-mlr-multivariate-linearity-fit-lm}
#| echo: false
#| edit: false
...
```{r chapter02-mlr-interpreting-a-partial-coefficient-beta-i-plot}
ggplot()+
...
```{webr chapter02-mlr-fitting-mlr-models-in-r-fit-lm}
...
```{webr chapter02-mlr-r-formulas-fit-lm}
#| echo: false
#| edit: false
...
```{webr chapter02-mlr-using-indexing}
#| echo: true
ads_mod$coefficients
```
#### The `coef()` function {#sec-the-coef-function}

```{webr chapter02-mlr-the-coef-function}
#| echo: true
coef(mod)
```
:::
...
```{webr chapter02-mlr-broom-tidy-setup}
#| edit: false
library(broom)
...
```{webr chapter02-mlr-global-statistics-with-anova}
anova(mod)
```
...
```{webr chapter02-mlr-global-statistics-with-glance}
glance(mod)
```
...
```{r chapter02-mlr-categorical-setup}
#| include: false
mtcars_cat <- mtcars %>%
  mutate(
...
```{webr chapter02-mlr-transmission-means}
#| echo: true
mtcars_cat %>%
  group_by(am_f) %>%
...
```{webr chapter02-mlr-transmission-lm}
#| echo: true
